...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'location' => [
            'regex' => 'Only letters, numbers, commas and dots are allowed.'
        ],
        'avatar' => [
            'mimes' => 'Make sure the image format is jpg, png, jpeg or gif.',
            'dimensions' => 'The dimensions of the image must be between 100x100 and 500x500 pixels.'
        ]
    ],
